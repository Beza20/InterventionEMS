...
final class CalibrationInterfaceController: WKInterfaceController {
	...
	@IBAction func didTapCalibrate() {
        ...
        switch state {
        case .environment:
            sensorManager.startMagnetometerCalibration(upper: false)
        case .magnet:
            sensorManager.startMagnetometerCalibration(upper: true)
        }
//		sensorManager.startMagnetometerCalibration()
	...
	private func setupCountdownUI() {
		switch state {
		case .environment:
			countdownTextLabel.setText("Touch your lower face")
		case .magnet:
			countdownTextLabel.setText("Touch your upper face")
		}
...
//			sensorManager.stopMagnetometerCalibrationForStandardDeviation()
            sensorManager.stopCalibration(upper: false)
...
//			sensorManager.stopMagnetometerCalibrationForMaximumValue()
            sensorManager.stopCalibration(upper:true)
